<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" 
                aria-expanded="{{ request()->is('teachers') || request()->is('addTeacher') ? 'true' : 'false' }}" data-target="#collapseTeachers"
                aria-controls="collapseTeachers">
                <i class="fas fa-fw fa-chalkboard-teacher"></i>
                <span>Teachers</span>
            </a>
            <div id="collapseTeachers" class="collapse {{ request()->is('teachers') || request()->is('addTeacher') ? 'show' : '' }}" aria-labelledby="headingTeachers" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsechildren"
            aria-expanded="{{ request()->is('children') || request()->is('addChild') ? 'true' : 'false' }}"
            aria-controls="collapsechildren">
            <i class="fas fa-fw fa-wrench"></i>
            <span>Children</span>
        </a>
        <div id="collapsechildren" class="collapse {{ request()->is('children') || request()->is('addChild') ? 'show' : '' }}"
            aria-labelledby="headingChildren" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseclasses"
            aria-expanded="{{ request()->is('classes') || request()->is('addClass') ? 'true' : 'false' }}"
            aria-controls="collapseclasses">
            <i class="fas fa-fw fa-wrench"></i>
            <span>Classes</span>
        </a>
        <div id="collapseclasses" class="collapse {{ request()->is('classes') || request()->is('addClass') ? 'show' : '' }}"
