...
<div class="container mt-5">
    <form  action="{{ route('insertTeacher') }}" method="post" enctype="multipart/form-data"  style="margin:5%">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('first_name') }}" name="first_name"  placeholder="jone" class="form-control" >
        </div>
        <div class="form-group">
            ...
            <input type="text" value="{{ old('last_name') }}" name="last_name" placeholder="doe" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="email" value="{{ old('email') }}" name="email"  placeholder="johndoe@example.org" class="form-control" >
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="file" value="{{ old('image') }}" name="image" placeholder="upload image.png or jpg" class="form-control" >
        </div>

        <div class="form-group">
        <input type="checkbox" {{ old('published') ? 'checked' : ''}}  name="published"  >
